...
At line 7, the run() method starts the rendering, and the stage is finally displayed. The rendering loop can be later stopped, suspended and resumed using,
respectively, stop(), suspend() and run().
